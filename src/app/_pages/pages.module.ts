...
@NgModule({
  declarations: [PagesComponent, AutoevaluacionProcesosComponent, MacroprocesosComponent, ProcesosComponent, RiesgosComponent, ProbabilidadOcurrenciaComponent, ImpactoComponent],
  imports: [
    CommonModule,
    NgxUiLoaderModule,
    NgxPaginationModule,
